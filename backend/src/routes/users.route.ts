...
import { authMiddleware, isAdmin, validateObjectId, validateQuery } from '#middlewares';
import { deleteUser, getUsers, restoreUser } from '#controllers';
import { paginationQuerySchema } from '#schemas';

const usersRouter = Router();

usersRouter.get('/', authMiddleware, isAdmin, validateQuery(paginationQuerySchema), getUsers);
